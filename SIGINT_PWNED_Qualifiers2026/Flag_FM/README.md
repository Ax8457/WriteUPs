...
<p align="justify">Because $e$ is 9-bytes long, it is bounded by 257 and 511. Which means that 511 messages would ideally be needed to recover $M$ and apply the CRT. Nonetheless because of the logic of 'Wrap around' of modular arithmetic (and RSA) and because the message is 64 bytes long and given the minimal length of $e$, the number of message ideally needed can be reduced to:</p>
